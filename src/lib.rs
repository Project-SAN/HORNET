...
mod tests {
    ...
    fn e2e_setup_and_data_forward() {
        ...
        for i in 0..lf {
            ...
            let _ = crate::packet::add_fs_into_payload(&keys_f[i], &fs_i, &mut p_f).expect("add fs f");
        ...
        for j in 0..lb {
            ...
            let _ = crate::packet::add_fs_into_payload(&keys_b[j], &fs_j, &mut p_b).expect("add fs b");
